        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false),
                    Afm = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    Dou = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    Phones = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    Email = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    Address = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    Representative = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DecimalValue = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AssetAttributeValues_AssetTypeFields_AssetTypeFieldId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    CanUseAsset = table.Column<bool>(type: "boolean", nullable: false),
                    Notes = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "member-id", "3", "Member", "MEMBER" },
                    { "moderator-id", "2", "Moderator", "MODERATOR" },
                    { "viewer-id", "4", "Viewer", "VIEWER" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssetAttributeValues_AssetId_AssetTypeFieldId",
                table: "AssetAttributeValues",
                columns: new[] { "AssetId", "AssetTypeFieldId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AssetAttributeValues_AssetTypeFieldId",
                table: "AssetAttributeValues",
                column: "AssetTypeFieldId");

            migrationBuilder.CreateIndex(
                name: "IX_AssetAttributeValues_DateValue",
                table: "AssetAttributeValues",
                column: "DateValue");

            migrationBuilder.CreateIndex(
                name: "IX_AssetAttributeValues_DecimalValue",
                table: "AssetAttributeValues",
                column: "DecimalValue");

            migrationBuilder.CreateIndex(
                name: "IX_AssetAttributeValues_StringValue",
                table: "AssetAttributeValues",
                column: "StringValue");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssetTypeFields_TenantId_AssetTypeId_Name",
                table: "AssetTypeFields",
                columns: new[] { "TenantId", "AssetTypeId", "Name" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_TenantId_Afm",
                table: "Customers",
                columns: new[] { "TenantId", "Afm" },
                unique: true);
